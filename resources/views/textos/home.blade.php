<p>Atlas Escolar foi desenvolvido para organizar e flexibilizar o controle de cadastro 
    de instituições de ensino e Estudantes.</p>

<p>
    Para tornar mais fácil a utilização do sistema “Atlas”, 
    fizemos um passo a passo para simplificar o processo de cadastro.
</p>
<p>
...
<p>
    Por último, é o momento da <b><a href="{{ route('turmas.show') }}" class="text-dark">matrícula</a></b>. Neste menu é possível acessar a lista de todas as turmas disponíveis e escolher os estudantes que as ocuparão.
</p>
<p class="mt-4">
    Para dúvidas referentes a funcionalidade, envie um e-mail para: <b>cleison51@hotmail.com.</b> 
</p>
